...
# Form implementation generated from reading ui file 'modifier_v.ui'
#
...
class Ui_Form(object):
    ...
    def modifier_v(self):
        ...
        elif(self.ag.verif_coul(self.lineEdit_9.text())==False or self.lineEdit_9.text()==""):
            self.warn("Couleur invalide")
        elif(self.lineEdit_11.text()=="" or self.lineEdit_11.text().isnumeric()==False):
            self.warn("Prix invalide")
        elif(self.lineEdit_11.text()!=self.v[5] or self.lineEdit_9.text()!=self.v[2]):
            self.v[5]=self.lineEdit_11.text()
            self.v[2]=self.lineEdit_9.text()
            self.succ("voiture modifiée avec succées")
        else:
            self.warn("veuillez modifier au moins un champ(couleur/prix)")
    ...
    def setupUi(self, Form):
        ...
        self.label.setStyleSheet("border-image: url(:/images/pexels-photo-2834653.jpeg);")
        self.label.setText("")
...
"")
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(30, 20, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"padding-bottom:7px ;")
        ...
        self.lineEdit_9.setGeometry(QtCore.QRect(110, 20, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"padding-bottom:7px ;")
        ...
        self.lineEdit_7.setGeometry(QtCore.QRect(30, 70, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"padding-bottom:7px ;")
        ...
        self.lineEdit_11.setGeometry(QtCore.QRect(180, 70, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"padding-bottom:7px ;")
        ...
        self.pushButton_2.clicked.connect(self.modifier_v)
