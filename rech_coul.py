...
class Ui_Form(object):
    ...
    def __init__(self,agence):
        ...
        self.l=[]
    def rechercher(self):
        coul = self.comboBox.currentText()
        alternative=[]
        if(coul!="Couleur"):
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(0, _translate("Form", "Couleur"))
        self.label_3.setText(_translate("Form", "Recherche par couleur :"))
        self.pushButton.setText(_translate("Form", "Rechercher"))
        
        for i in range(len(self.ag.liste_v)):
            self.l.append(self.ag.liste_v[i][2])
