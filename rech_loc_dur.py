...
class TableModel(QtCore.QAbstractTableModel):
    def __init__(self, data):
        ...
        self._data = data
        self.columns=["Num","CIN","Matricule","Date de location","Montant"]
...
"padding-bottom:7px ;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "Recherche par durée de location :"))
        self.pushButton_2.setText(_translate("Form", "Rechercher"))
        self.lineEdit_4.setPlaceholderText(_translate("Form", "Durée"))
